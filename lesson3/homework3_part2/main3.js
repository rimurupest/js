...
for (const simpson of simpsons) {
    document.write(`<div class="simpson_card">`)
    document.write(`<h1>${simpson.name} ${simpson.surname} age is - ${simpson.age}</h1><p>${simpson.info}</p><img src="${simpson.photo}" alt=""> `);
    document.write(`</div>`)
}
...
for (const product of products) {
    document.write(`<div class="product_card"><h3 class="product_title">${product.title} ${product.price}</h3><img src="${product.image}" alt="" class="product_image"></div>`)
}
document.write(`</div>`)